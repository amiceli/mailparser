...
(function () {
  var parent = document.querySelector('.for--file');
  ...
  if (parent) {
    ...
    input.addEventListener('change', function () {
      ...
      var split = value.includes('/') ? value.split('/') : value.split('\\');
...
/******/ 	__webpack_require__.O(undefined, ["css/reset","css/app"], () => (__webpack_require__("./resources/css/app.css")))
